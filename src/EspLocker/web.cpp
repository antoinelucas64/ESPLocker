...
String Web::createAdminPage() {
  ...
  if (admin) out += "<p>SSID: "
                    + config.getSSID() + "</p>";
  out += "<p>Password "
         + config.getPassword() + "</p><a class=\"button button-on\" href=\"" + IP + "/admin/wifi\">Modify</a>";

  if (admin) out += "<p>Web administration</p>"
                    "<p>User "
                    + config.getWWWUser() + "<p>Password "
                    + config.getWWWPassword() + "</p><a class=\"button button-on\" href=\"" + IP + "/admin/password\">Modify</a>";
